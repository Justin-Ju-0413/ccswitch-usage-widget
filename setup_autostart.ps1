...
$l1.TargetPath = $pythonw; $l1.Arguments = $script; $l1.WorkingDirectory = $workDir; $l1.Description = 'TokenTicker - AI usage ticker'; $l1.Save()
$l2 = $ws.CreateShortcut((Join-Path $desktopDir 'TokenTicker.lnk'))
$l2.TargetPath = $pythonw; $l2.Arguments = $script; $l2.WorkingDirectory = $workDir; $l2.Description = 'TokenTicker - AI usage ticker'; $l2.Save()
