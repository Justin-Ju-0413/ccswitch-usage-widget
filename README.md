<p align="center">
  <img src=".github/persona-banner.svg" width="100%" alt="TokenTicker — Your AI spend, as candlesticks">
</p>

# TokenTicker (ccswitch-usage-widget)

**Your AI spend, as candlesticks.**
**AI 花费,像行情一样看。**

A desktop floating widget that turns the AI usage recorded by [CC Switch](https://github.com/farion1231/cc-switch) into a market terminal — spend candlesticks, change percentages and a usage table, refreshed live and always on top.

桌面悬浮窗,把 [CC Switch](https://github.com/farion1231/cc-switch) 记录的 AI 用量做成行情终端:花费 K 线 + 涨跌幅 + 用量表格,桌面常驻实时刷新,像看股票一样看你的 AI 花费。
